...
/**
 * Client-Side Activity Logger Utility
 * Logs user activities to the activity_logs table for audit and tracking purposes
 * This version is compatible with Next.js Client Components
 */
...
/**
 * Log an activity to the database (Client-side version)
...
/**
 * Log authentication activities (Client-side version)
 */
...
/**
 * Log profile activities (Client-side version)
 */
...
/**
 * Log project activities (Client-side version)
 */
...
/**
 * Log billing activities (Client-side version)
 */
...
/**
 * Log security activities (Client-side version)
 */
...
/**
 * Helper function to extract IP address and User Agent from browser
 * Note: In client-side code, we can't directly access request headers
...
export function getClientInfo() {
  ...
  // for security reasons. This would need to be obtained from a server endpoint
  // or passed from the server if needed.
  return { 
    ipAddress: 'client-side', // Placeholder - would need server endpoint to get real IP
    userAgent 
  };
}

/**
 * Get recent activity logs for a user (Client-side version)
 */
