...
export default async function ProjectsPage() {
  ...
  // Get overdue projects (projects with end_date in the past and not completed)
  ...
  return (
    <DashboardLayout user={userProfile} stats={stats}>
      <div id="projects-page" className="space-y-6">
        <div id="projects-page-header" className="border-b border-gray-200 pb-4">
