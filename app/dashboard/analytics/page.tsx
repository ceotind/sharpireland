  ...
  return (
    <DashboardLayout user={userProfile} stats={stats}>
      <div id="analytics-page" className="space-y-6">
        <div id="analytics-page-header" className="border-b border-gray-200 pb-4">
        ...
        <AnalyticsSection className="w-full" />
      </div>
    </DashboardLayout>
  );
}
...
export const metadata = {
  ...
  description: 'Track your performance metrics and business insights',
};