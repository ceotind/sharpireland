...
const DashboardLayout: React.FC<DashboardLayoutProps> = ({ children, user, stats }) => {
  ...
  return (
    <div id="dashboard-layout-container" className="min-h-screen bg-gray-50">
      ...
      {/* Sidebar */}
      <div id="dashboard-sidebar" className={`fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-lg transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 ${
        ...
        <div id="sidebar-user-profile" className="absolute bottom-0 left-0 right-0 p-4 border-t border-gray-200">
      ...
      {/* Main content */}
      <div id="dashboard-main-content" className="lg:pl-64">
        {/* Top header */}
        <div id="dashboard-header" className="sticky top-0 z-40 bg-white shadow-sm border-b border-gray-200">
          <div id="dashboard-header-content" className="px-4 sm:px-6 lg:px-8">
            <div id="dashboard-header-inner" className="flex justify-between items-center h-16">
              {/* Mobile menu button */}
              <button
              ...
              {/* Header title */}
              <div id="dashboard-header-title" className="flex-1 lg:flex-none">
                <h1 className="text-2xl font-semibold text-gray-900">Dashboard</h1>
              </div>

              {/* Header actions */}
              <div id="dashboard-header-actions" className="flex items-center space-x-4">
                {/* Notifications */}
                <button
                ...
                >
                  ...
                  {unreadNotificationCount > 0 && (
                    <span id="notifications-badge" className="absolute -top-1 -right-1 h-5 w-5 bg-red-500 text-white text-xs font-medium rounded-full flex items-center justify-center">
        ...
        {/* Page content */}
        <main id="dashboard-page-content" className="py-8">
          <div id="dashboard-content-container" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            {children}
          </div>
        </main>
      </div>
