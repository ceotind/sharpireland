      ...
      <div className="w-full max-w-5xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-start mb-12">
          ...
          <div className="animate-element bg-[var(--bg-100)]/80 rounded-2xl p-8 flex flex-col gap-6 shadow-md border border-[var(--bg-200)]">
            <h3 className="text-xl font-semibold text-[var(--primary-100)] mb-2">{solution.benefits.title}</h3>
          ...
          {/* How It Works */}
          <div className="animate-element bg-[var(--bg-100)]/80 rounded-2xl p-8 flex flex-col gap-6 shadow-md border border-[var(--bg-200)]">
            <h3 className="text-xl font-semibold text-[var(--primary-100)] mb-2">{solution.steps.title}</h3>
            {solution.steps.items.map((step, index) => (
              <div key={index} className="flex items-start gap-4">
                <span className="w-8 h-8 flex items-center justify-center rounded-full bg-[var(--primary-100)] text-white font-bold text-lg mt-1">{index+1}</span>
                <div className="text-left">
        ...
        <div className="animate-element flex justify-center">
          <button
            className="px-8 py-3 bg-[var(--primary-100)] text-white font-semibold rounded-lg shadow-lg hover:bg-[var(--primary-200)] focus:outline-none focus:ring-2 focus:ring-[var(--primary-100)] focus:ring-offset-2 text-lg transition-all duration-200"
          >
            {solution.ctaButton}
          </button>
        </div>
