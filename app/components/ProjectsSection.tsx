...
import { projectsContainer, projectCard } from "../utils/motion-variants";
      ...
      <div className="w-full max-w-screen-xl mx-auto px-2 sm:px-4 lg:px-8 flex flex-col gap-8 md:gap-12">
        ...
        >
          {projects.map((project) => (
            <motion.article
              key={project.id}
              className="bg-[var(--bg-200)] p-5 sm:p-6 rounded-lg border border-[var(--bg-300)] flex flex-col h-full"
              role="listitem"
              itemScope
            ...
            >
              ...
              <a
                ...
                className="inline-block mt-4 pt-4 text-[var(--accent-green)] font-medium text-base sm:text-lg"
