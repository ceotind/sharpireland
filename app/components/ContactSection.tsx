  ...
  return (
    <section id="contact" ref={sectionRef} className="bg-[var(--background)] py-20 md:py-32" aria-labelledby="contact-heading">
      <div className="w-full max-w-screen-md mx-auto px-4 lg:px-8 flex flex-col gap-10">
        ...
        {/* Success Message */}
        {formState === 'success' && (
          <div className="animate-element mb-6 p-4 bg-green-50 border border-green-200 rounded-lg">
        ...
        {formState === 'error' && message && (
          <div className="animate-element mb-6 p-4 bg-red-50 border border-red-200 rounded-lg">
            <div className="flex items-center">
