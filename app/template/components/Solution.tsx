      ...
      <div className="w-full max-w-5xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-start mb-12">
          ...
          <div className="animate-element bg-[var(--bg-100)]/80 rounded-2xl p-8 flex flex-col gap-6 shadow-md border border-[var(--bg-200)]">
            <h3 className="text-xl font-semibold text-[var(--accent-green)] mb-2">{content.solution.benefits.title}</h3>
            {content.solution.benefits.items.map((benefit, index) => (
          ...
          {/* How It Works */}
          <div className="animate-element bg-[var(--bg-100)]/80 rounded-2xl p-8 flex flex-col gap-6 shadow-md border border-[var(--bg-200)]">
            <h3 className="text-xl font-semibold text-[var(--accent-green)] mb-2">{content.solution.steps.title}</h3>
            {content.solution.steps.items.map((step, index) => (
              <div key={index} className="flex items-start gap-4">
