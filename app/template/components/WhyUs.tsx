      ...
      <div className="w-full max-w-3xl mx-auto px-4">
        <div className="text-center mb-14">
          <span className="animate-element text-sm uppercase tracking-wide text-[var(--accent-green)] font-medium">
            {content.whyUs.tagline}
          </span>
          <h2 className="animate-element mt-4 text-3xl sm:text-4xl font-bold text-[var(--text-100)]">
            {content.whyUs.heading} <span className="text-[var(--accent-green)]">{content.whyUs.headingHighlight}</span>
          </h2>
        ...
        <div className="relative">
          ...
          <ul className="space-y-10">
            {content.whyUs.reasons.map((reason, idx) => {
              ...
              return (
                <li key={idx} className="animate-element flex items-start relative">
                  ...
                  <div className="relative flex flex-col items-center w-12 z-10">
                    <div className="w-10 h-10 rounded-full border border-[var(--accent-green)] bg-[var(--bg-100)] flex items-center justify-center mb-2">
                      <Icon size={28} weight="duotone" className="text-[var(--accent-green)]" />
                    </div>
                    {/* Connector for mobile */}
                    {idx !== content.whyUs.reasons.length - 1 && (
                  ...
                  <div className="flex-1 pl-4">
                    <div className="flex flex-col sm:flex-row sm:items-center gap-2 mb-1">
                      ...
                      <span className="self-start sm:self-auto px-2 py-0.5 rounded-full bg-[var(--bg-200)] text-[var(--accent-green)] text-xs font-medium dark:bg-[var(--accent-green)] dark:text-white dark:text-xs dark:font-medium">{reason.stat}</span>
                    </div>
