        ...
        <div id="business-planner-hero-content" className="text-center">
          ...
          >
            <motion.button
              ...
              className="px-8 py-4 rounded-xl text-base font-medium text-[var(--primary-100)] bg-white hover:bg-gray-50 transition-colors duration-200"
              variants={heroButton}
              initial="rest"
              whileHover="hover"
              whileTap="tap"
              onClick={() => router.push("/login?redirect=/business-planner/chat")}
            >
