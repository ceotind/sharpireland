  ...
  async headers() {
    ...
    const developmentCSP = {
      ...
      value: [
        ...
        "img-src 'self' data: blob: https: http:",
        "media-src 'self' data: blob:",
        "connect-src 'self' https://www.google-analytics.com https://vitals.vercel-insights.com https://*.supabase.co https://accounts.google.com https://github.com https://*.agora.io https://*.edge.agora.io https://*.sd-rtn.com https://*.edge.sd-rtn.com wss://*.agora.io wss://*.edge.agora.io wss://*.sd-rtn.com wss://*.edge.sd-rtn.com ws: wss:",
        "frame-src 'none'",
        "object-src 'none'",
        "base-uri 'self'",
        "form-action 'self'",
